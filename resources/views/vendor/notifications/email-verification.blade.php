...
<head>
    ...
    <title>Verificació del teu compte</title>
    <style>
        /* Base Reset */
...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                <h2>Benvingut/uda a Serralleria Solidària!</h2>

                <p>Gràcies per registrar-te. Per verificar el teu compte, fes clic al botó de sota:</p>

                <div class="button-container">
                    <a href="{{ $url }}" class="button">Verificar el meu compte</a>
                </div>

                <p>Si no has creat aquest compte, pots ignorat aquest correu.</p>
        ...
        <div class="footer">
            <p>&copy; {{ date('Y') }} <strong>Serralleria Solidària</strong>. Tots els drets reservats.</p>
        </div>
    </div>
</body>
</html>
