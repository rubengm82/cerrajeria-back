...
class OrderController extends Controller
{
    ...
    public function checkout(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'customer.billing_address' => 'nullable|string|max:255',
            'customer.billing_zip_code' => 'nullable|string|max:10',
            'customer.billing_province' => 'nullable|string|max:255',
            ...
            'order.billing_address' => 'nullable|string|max:255',
            'order.billing_zip_code' => 'nullable|string|max:10',
            'order.billing_province' => 'nullable|string|max:255',
            'order.billing_country' => 'nullable|string|max:255',
        ...
        try {
            ...
            $order = Order::create([
                ...
                'billing_address' => $orderData['billing_address'] ?? $customer['billing_address'] ?? null,
                'billing_zip_code' => $orderData['billing_zip_code'] ?? $customer['billing_zip_code'] ?? null,
                'billing_province' => $orderData['billing_province'] ?? $customer['billing_province'] ?? null,
                'billing_country' => $orderData['billing_country'] ?? $customer['billing_country'] ?? 'España',
