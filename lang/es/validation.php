...
return [
    ...
    | usados por el validador. Algunas reglas tienen varias versiones, como
    | las reglas de tamaño. Puedes ajustar estos mensajes cuando lo necesites.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor indicado para :attribute ha aparecido en una filtración de datos. Elige otro valor.',
    ],
    ...
    */
    ...
    'custom' => [
        ...
        'conflict_ranges' => 'El :attribute entra en conflicto con un rango de fechas existente.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas sustituyen el marcador :attribute por nombres
    | más legibles, como "dirección de correo electrónico" en lugar de "email".
    |
    */
    ...
    'attributes' => [
        ...
        'customer.zip_code' => 'código postal del cliente',
        ...
        'name' => 'nombre',
        'order.installation_address' => 'dirección de instalación',
